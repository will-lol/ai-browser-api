...
function installMockTransaction() {
  ...
  ;(runtimeDb as { transaction: typeof runtimeDb.transaction }).transaction = transactionStub
}
...
afterEach(() => {
  ;(runtimeDb as { transaction: typeof runtimeDb.transaction }).transaction = originalTransaction
