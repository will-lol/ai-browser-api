...
mock.module("@/background/runtime/provider-registry", () => ({
...
const providerRegistry = await import("@/background/runtime/provider-registry");
...
const { listPendingRequestsForOrigin, listProviders } =
  await import("@/background/runtime/query-service");
