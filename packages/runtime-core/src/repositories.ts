...
export class ProvidersRepository extends Context.Tag("@llm-bridge/runtime-core/ProvidersRepository")<
  ProvidersRepository,
...
export class ModelsRepository extends Context.Tag("@llm-bridge/runtime-core/ModelsRepository")<
  ModelsRepository,
  ModelsRepositoryApi
>() {}
...
export class AuthRepository extends Context.Tag("@llm-bridge/runtime-core/AuthRepository")<
  AuthRepository,
  AuthRepositoryApi
>() {}
...
export interface PermissionsRepositoryApi {
  ...
  getModelPermission: (origin: string, modelID: string) => AppEffect<PermissionStatus>
...
export class PendingRequestsRepository extends Context.Tag("@llm-bridge/runtime-core/PendingRequestsRepository")<
...
export class ConfigRepository extends Context.Tag("@llm-bridge/runtime-core/ConfigRepository")<
  ConfigRepository,
  ConfigRepositoryApi
>() {}
...
export class ModelExecutionRepository extends Context.Tag("@llm-bridge/runtime-core/ModelExecutionRepository")<
